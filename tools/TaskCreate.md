...
| | |
| --- | --- |
| first seen | 2.1.142 (2026-05-14) |
| status | **active** at 2.1.229 |
| versions present | 78 of 389 |
...
timeline TD
    title TaskCreate — major events
    section sdk-legacy era
        2.1.142<br>2026-05-14 : ⚪ added to the roster
```
...
| version | date | event |
| --- | --- | --- |
| 2.1.142 | 2026-05-14 | added to the roster |
