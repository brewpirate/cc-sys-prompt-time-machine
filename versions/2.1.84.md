...
- tools touched: Bash, CronCreate, CronDelete, CronList, EnterWorktree, Glob, Grep, Read, TaskCreate, TaskOutput, TodoWrite
...
Measured against 2.1.80 — intermediate versions uncaptured on this entrypoint:

- **7 models** (all except `claude-fable-5`, `claude-opus-5`, `claude-sonnet-5`): prompt +11149B 🟠 ~[System, Doing tasks, Using your tools, Tone and style, auto memory, Environment] · tools 🟠 schema[Bash, CronCreate, EnterWorktree, Grep, TaskCreate] 🟠 desc[Bash, CronCreate, CronDelete, CronList, Glob, Read, TaskCreate, TaskOutput]
- `claude-fable-5`, `claude-opus-5`, `claude-sonnet-5`: prompt +11151B 🟠 ~[System, Doing tasks, Using your tools, Tone and style, auto memory, Environment] · tools 🟠 schema[Bash, CronCreate, EnterWorktree, Grep, TaskCreate] 🟠 desc[Bash, CronCreate, CronDelete, CronList, Glob, Read, TaskCreate, TaskOutput]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../sdk-capture/2.1.84/claude-fable-5.md) | [tools](../sdk-capture/2.1.84/claude-fable-5.tools.json) | [prompt](../cli-capture/2.1.84/claude-fable-5.md) | [tools](../cli-capture/2.1.84/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../sdk-capture/2.1.84/claude-haiku-4-5.md) | [tools](../sdk-capture/2.1.84/claude-haiku-4-5.tools.json) | [prompt](../cli-capture/2.1.84/claude-haiku-4-5.md) | [tools](../cli-capture/2.1.84/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../sdk-capture/2.1.84/claude-opus-4-5.md) | [tools](../sdk-capture/2.1.84/claude-opus-4-5.tools.json) | [prompt](../cli-capture/2.1.84/claude-opus-4-5.md) | [tools](../cli-capture/2.1.84/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../sdk-capture/2.1.84/claude-opus-4-6.md) | [tools](../sdk-capture/2.1.84/claude-opus-4-6.tools.json) | [prompt](../cli-capture/2.1.84/claude-opus-4-6.md) | [tools](../cli-capture/2.1.84/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../sdk-capture/2.1.84/claude-opus-4-7.md) | [tools](../sdk-capture/2.1.84/claude-opus-4-7.tools.json) | [prompt](../cli-capture/2.1.84/claude-opus-4-7.md) | [tools](../cli-capture/2.1.84/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../sdk-capture/2.1.84/claude-opus-4-8.md) | [tools](../sdk-capture/2.1.84/claude-opus-4-8.tools.json) | [prompt](../cli-capture/2.1.84/claude-opus-4-8.md) | [tools](../cli-capture/2.1.84/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../sdk-capture/2.1.84/claude-opus-5.md) | [tools](../sdk-capture/2.1.84/claude-opus-5.tools.json) | [prompt](../cli-capture/2.1.84/claude-opus-5.md) | [tools](../cli-capture/2.1.84/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../sdk-capture/2.1.84/claude-sonnet-4-5.md) | [tools](../sdk-capture/2.1.84/claude-sonnet-4-5.tools.json) | [prompt](../cli-capture/2.1.84/claude-sonnet-4-5.md) | [tools](../cli-capture/2.1.84/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../sdk-capture/2.1.84/claude-sonnet-4-6.md) | [tools](../sdk-capture/2.1.84/claude-sonnet-4-6.tools.json) | [prompt](../cli-capture/2.1.84/claude-sonnet-4-6.md) | [tools](../cli-capture/2.1.84/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../sdk-capture/2.1.84/claude-sonnet-5.md) | [tools](../sdk-capture/2.1.84/claude-sonnet-5.tools.json) | [prompt](../cli-capture/2.1.84/claude-sonnet-5.md) | [tools](../cli-capture/2.1.84/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
