...
prev [2.1.96](2.1.96.md) (same day earlier) · next [2.1.98](2.1.98.md) (1 day later)
...
- tools touched: none
- changelog coverage: 46 entries; prompt changes **not mentioned**; tools mentioned by name: n/a

## SDK changes

Measured against 2.1.96, sdk-cli entrypoint:

- **all 10 models**: prompt +4B 🟠 ~[Environment]

## Interactive CLI changes

Measured against 2.1.96:

- **all 10 models**: prompt +5B 🟠 ~[Output efficiency, Environment]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../sdk-capture/2.1.97/claude-fable-5.md) | [tools](../sdk-capture/2.1.97/claude-fable-5.tools.json) | [prompt](../cli-capture/2.1.97/claude-fable-5.md) | [tools](../cli-capture/2.1.97/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../sdk-capture/2.1.97/claude-haiku-4-5.md) | [tools](../sdk-capture/2.1.97/claude-haiku-4-5.tools.json) | [prompt](../cli-capture/2.1.97/claude-haiku-4-5.md) | [tools](../cli-capture/2.1.97/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../sdk-capture/2.1.97/claude-opus-4-5.md) | [tools](../sdk-capture/2.1.97/claude-opus-4-5.tools.json) | [prompt](../cli-capture/2.1.97/claude-opus-4-5.md) | [tools](../cli-capture/2.1.97/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../sdk-capture/2.1.97/claude-opus-4-6.md) | [tools](../sdk-capture/2.1.97/claude-opus-4-6.tools.json) | [prompt](../cli-capture/2.1.97/claude-opus-4-6.md) | [tools](../cli-capture/2.1.97/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../sdk-capture/2.1.97/claude-opus-4-7.md) | [tools](../sdk-capture/2.1.97/claude-opus-4-7.tools.json) | [prompt](../cli-capture/2.1.97/claude-opus-4-7.md) | [tools](../cli-capture/2.1.97/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../sdk-capture/2.1.97/claude-opus-4-8.md) | [tools](../sdk-capture/2.1.97/claude-opus-4-8.tools.json) | [prompt](../cli-capture/2.1.97/claude-opus-4-8.md) | [tools](../cli-capture/2.1.97/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../sdk-capture/2.1.97/claude-opus-5.md) | [tools](../sdk-capture/2.1.97/claude-opus-5.tools.json) | [prompt](../cli-capture/2.1.97/claude-opus-5.md) | [tools](../cli-capture/2.1.97/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../sdk-capture/2.1.97/claude-sonnet-4-5.md) | [tools](../sdk-capture/2.1.97/claude-sonnet-4-5.tools.json) | [prompt](../cli-capture/2.1.97/claude-sonnet-4-5.md) | [tools](../cli-capture/2.1.97/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../sdk-capture/2.1.97/claude-sonnet-4-6.md) | [tools](../sdk-capture/2.1.97/claude-sonnet-4-6.tools.json) | [prompt](../cli-capture/2.1.97/claude-sonnet-4-6.md) | [tools](../cli-capture/2.1.97/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../sdk-capture/2.1.97/claude-sonnet-5.md) | [tools](../sdk-capture/2.1.97/claude-sonnet-5.tools.json) | [prompt](../cli-capture/2.1.97/claude-sonnet-5.md) | [tools](../cli-capture/2.1.97/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
