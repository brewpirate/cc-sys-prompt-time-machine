...
- tools touched: ReportFindings
- changelog coverage: 27 entries; prompt changes **not mentioned**; tools mentioned by name: **0 of 1**
...
Measured against 2.1.193 — intermediate versions uncaptured on this entrypoint:
