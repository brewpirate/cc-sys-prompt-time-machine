...
prev [2.1.138](2.1.138.md) (2 days earlier) · next [2.1.140](2.1.140.md) (1 day later)
...
- tools touched: Agent, EnterWorktree, ListMcpResourcesTool, ReadMcpResourceTool
- changelog coverage: 50 entries; prompt changes **not mentioned**; tools mentioned by name: **0 of 4**

## SDK changes

Measured against 2.1.138, sdk-cli entrypoint:

- **all 10 models**: prompt +408B 🟠 ~[auto memory, Context management] · tools 🟢 +[ListMcpResourcesTool, ReadMcpResourceTool] 🟠 desc[Agent]

## Interactive CLI changes

Measured against 2.1.132 — intermediate versions uncaptured on this entrypoint:

- **all 10 models**: prompt +408B 🟠 ~[auto memory, Context management] · tools 🟠 desc[Agent, EnterWorktree]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../sdk-capture/2.1.139/claude-fable-5.md) | [tools](../sdk-capture/2.1.139/claude-fable-5.tools.json) | [prompt](../cli-capture/2.1.139/claude-fable-5.md) | [tools](../cli-capture/2.1.139/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../sdk-capture/2.1.139/claude-haiku-4-5.md) | [tools](../sdk-capture/2.1.139/claude-haiku-4-5.tools.json) | [prompt](../cli-capture/2.1.139/claude-haiku-4-5.md) | [tools](../cli-capture/2.1.139/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../sdk-capture/2.1.139/claude-opus-4-5.md) | [tools](../sdk-capture/2.1.139/claude-opus-4-5.tools.json) | [prompt](../cli-capture/2.1.139/claude-opus-4-5.md) | [tools](../cli-capture/2.1.139/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../sdk-capture/2.1.139/claude-opus-4-6.md) | [tools](../sdk-capture/2.1.139/claude-opus-4-6.tools.json) | [prompt](../cli-capture/2.1.139/claude-opus-4-6.md) | [tools](../cli-capture/2.1.139/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../sdk-capture/2.1.139/claude-opus-4-7.md) | [tools](../sdk-capture/2.1.139/claude-opus-4-7.tools.json) | [prompt](../cli-capture/2.1.139/claude-opus-4-7.md) | [tools](../cli-capture/2.1.139/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../sdk-capture/2.1.139/claude-opus-4-8.md) | [tools](../sdk-capture/2.1.139/claude-opus-4-8.tools.json) | [prompt](../cli-capture/2.1.139/claude-opus-4-8.md) | [tools](../cli-capture/2.1.139/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../sdk-capture/2.1.139/claude-opus-5.md) | [tools](../sdk-capture/2.1.139/claude-opus-5.tools.json) | [prompt](../cli-capture/2.1.139/claude-opus-5.md) | [tools](../cli-capture/2.1.139/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../sdk-capture/2.1.139/claude-sonnet-4-5.md) | [tools](../sdk-capture/2.1.139/claude-sonnet-4-5.tools.json) | [prompt](../cli-capture/2.1.139/claude-sonnet-4-5.md) | [tools](../cli-capture/2.1.139/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../sdk-capture/2.1.139/claude-sonnet-4-6.md) | [tools](../sdk-capture/2.1.139/claude-sonnet-4-6.tools.json) | [prompt](../cli-capture/2.1.139/claude-sonnet-4-6.md) | [tools](../cli-capture/2.1.139/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../sdk-capture/2.1.139/claude-sonnet-5.md) | [tools](../sdk-capture/2.1.139/claude-sonnet-5.tools.json) | [prompt](../cli-capture/2.1.139/claude-sonnet-5.md) | [tools](../cli-capture/2.1.139/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
