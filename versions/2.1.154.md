...
- tools touched: Agent, AskUserQuestion, Bash, Edit, Glob, Grep, Read, WebFetch, WebSearch, Workflow, Write
...
Measured against 2.1.149 — intermediate versions uncaptured on this entrypoint:

- **6 models** (all except `claude-fable-5`, `claude-opus-4-8`, `claude-opus-5`, `claude-sonnet-5`): prompt -5B 🟠 ~[Environment] · tools 🟢 +[Workflow] 🟠 desc[AskUserQuestion]
- `claude-fable-5`, `claude-opus-5`: prompt -20788B 🟢 +[Harness, Memory] 🔴 −[System, Doing tasks, Executing actions with care, Using your tools, Tone and style, Text output (does not apply to tool calls), auto memory] 🟠 ~[(intro), Session-specific guidance, Environment] · tools 🟢 +[Workflow] 🟠 desc[Agent, AskUserQuestion, Bash, Edit, Read, WebFetch, WebSearch, Write]
- `claude-opus-4-8`: prompt -20703B 🟢 +[Harness, Memory] 🔴 −[System, Doing tasks, Executing actions with care, Using your tools, Tone and style, Text output (does not apply to tool calls), auto memory] 🟠 ~[(intro), Session-specific guidance, Environment] · tools 🟢 +[Workflow] 🟠 desc[Agent, AskUserQuestion, Bash, Edit, Read, WebFetch, WebSearch, Write]
- `claude-sonnet-5`: prompt -5B 🟠 ~[Environment] · tools 🟢 +[Workflow] 🟠 desc[AskUserQuestion, Bash]
