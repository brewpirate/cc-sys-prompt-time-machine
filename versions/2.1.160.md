...
prev [2.1.159](2.1.159.md) (1 day earlier) · next [2.1.161](2.1.161.md) (1 day later)
...
- changelog coverage: 27 entries; prompt changes n/a; tools mentioned by name: **0 of 2**

## SDK changes

Measured against 2.1.159, sdk-cli entrypoint:

- **all 10 models**: tools 🟠 desc[Workflow]

## Interactive CLI changes

Measured against 2.1.159:

- **7 models** (all except `claude-fable-5`, `claude-sonnet-4-5`, `claude-sonnet-5`): tools 🟠 desc[Workflow]
- `claude-fable-5`, `claude-sonnet-4-5`, `claude-sonnet-5`: tools 🔴 −[WaitForMcpServers] 🟠 desc[Workflow]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../sdk-capture/2.1.160/claude-fable-5.md) | [tools](../sdk-capture/2.1.160/claude-fable-5.tools.json) | [prompt](../cli-capture/2.1.160/claude-fable-5.md) | [tools](../cli-capture/2.1.160/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../sdk-capture/2.1.160/claude-haiku-4-5.md) | [tools](../sdk-capture/2.1.160/claude-haiku-4-5.tools.json) | [prompt](../cli-capture/2.1.160/claude-haiku-4-5.md) | [tools](../cli-capture/2.1.160/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../sdk-capture/2.1.160/claude-opus-4-5.md) | [tools](../sdk-capture/2.1.160/claude-opus-4-5.tools.json) | [prompt](../cli-capture/2.1.160/claude-opus-4-5.md) | [tools](../cli-capture/2.1.160/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../sdk-capture/2.1.160/claude-opus-4-6.md) | [tools](../sdk-capture/2.1.160/claude-opus-4-6.tools.json) | [prompt](../cli-capture/2.1.160/claude-opus-4-6.md) | [tools](../cli-capture/2.1.160/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../sdk-capture/2.1.160/claude-opus-4-7.md) | [tools](../sdk-capture/2.1.160/claude-opus-4-7.tools.json) | [prompt](../cli-capture/2.1.160/claude-opus-4-7.md) | [tools](../cli-capture/2.1.160/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../sdk-capture/2.1.160/claude-opus-4-8.md) | [tools](../sdk-capture/2.1.160/claude-opus-4-8.tools.json) | [prompt](../cli-capture/2.1.160/claude-opus-4-8.md) | [tools](../cli-capture/2.1.160/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../sdk-capture/2.1.160/claude-opus-5.md) | [tools](../sdk-capture/2.1.160/claude-opus-5.tools.json) | [prompt](../cli-capture/2.1.160/claude-opus-5.md) | [tools](../cli-capture/2.1.160/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../sdk-capture/2.1.160/claude-sonnet-4-5.md) | [tools](../sdk-capture/2.1.160/claude-sonnet-4-5.tools.json) | [prompt](../cli-capture/2.1.160/claude-sonnet-4-5.md) | [tools](../cli-capture/2.1.160/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../sdk-capture/2.1.160/claude-sonnet-4-6.md) | [tools](../sdk-capture/2.1.160/claude-sonnet-4-6.tools.json) | [prompt](../cli-capture/2.1.160/claude-sonnet-4-6.md) | [tools](../cli-capture/2.1.160/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../sdk-capture/2.1.160/claude-sonnet-5.md) | [tools](../sdk-capture/2.1.160/claude-sonnet-5.tools.json) | [prompt](../cli-capture/2.1.160/claude-sonnet-5.md) | [tools](../cli-capture/2.1.160/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
