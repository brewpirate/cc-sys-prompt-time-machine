...
prev [2.1.215](2.1.215.md) (1 day earlier) · next [2.1.217](2.1.217.md) (1 day later)
...
- tools touched: Skill, WaitForMcpServers
- changelog coverage: 40 entries; prompt changes n/a; tools mentioned by name: **0 of 2**

## SDK changes

Measured against 2.1.215, sdk-cli entrypoint:

- **all 10 models**: tools 🟠 desc[Skill]

## Interactive CLI changes

Measured against 2.1.215:

- `claude-fable-5`, `claude-opus-4-5`, `claude-opus-4-6`, `claude-sonnet-4-6`: tools 🟠 desc[Skill]
- `claude-haiku-4-5`, `claude-sonnet-4-5`, `claude-sonnet-5`: tools 🔴 −[WaitForMcpServers] 🟠 desc[Skill]
- `claude-opus-4-7`, `claude-opus-4-8`, `claude-opus-5`: tools 🟢 +[WaitForMcpServers] 🟠 desc[Skill]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../capture/sdk/2.1.216/claude-fable-5.md) | [tools](../capture/sdk/2.1.216/claude-fable-5.tools.json) | [prompt](../capture/cli/2.1.216/claude-fable-5.md) | [tools](../capture/cli/2.1.216/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../capture/sdk/2.1.216/claude-haiku-4-5.md) | [tools](../capture/sdk/2.1.216/claude-haiku-4-5.tools.json) | [prompt](../capture/cli/2.1.216/claude-haiku-4-5.md) | [tools](../capture/cli/2.1.216/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../capture/sdk/2.1.216/claude-opus-4-5.md) | [tools](../capture/sdk/2.1.216/claude-opus-4-5.tools.json) | [prompt](../capture/cli/2.1.216/claude-opus-4-5.md) | [tools](../capture/cli/2.1.216/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../capture/sdk/2.1.216/claude-opus-4-6.md) | [tools](../capture/sdk/2.1.216/claude-opus-4-6.tools.json) | [prompt](../capture/cli/2.1.216/claude-opus-4-6.md) | [tools](../capture/cli/2.1.216/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../capture/sdk/2.1.216/claude-opus-4-7.md) | [tools](../capture/sdk/2.1.216/claude-opus-4-7.tools.json) | [prompt](../capture/cli/2.1.216/claude-opus-4-7.md) | [tools](../capture/cli/2.1.216/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../capture/sdk/2.1.216/claude-opus-4-8.md) | [tools](../capture/sdk/2.1.216/claude-opus-4-8.tools.json) | [prompt](../capture/cli/2.1.216/claude-opus-4-8.md) | [tools](../capture/cli/2.1.216/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../capture/sdk/2.1.216/claude-opus-5.md) | [tools](../capture/sdk/2.1.216/claude-opus-5.tools.json) | [prompt](../capture/cli/2.1.216/claude-opus-5.md) | [tools](../capture/cli/2.1.216/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../capture/sdk/2.1.216/claude-sonnet-4-5.md) | [tools](../capture/sdk/2.1.216/claude-sonnet-4-5.tools.json) | [prompt](../capture/cli/2.1.216/claude-sonnet-4-5.md) | [tools](../capture/cli/2.1.216/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../capture/sdk/2.1.216/claude-sonnet-4-6.md) | [tools](../capture/sdk/2.1.216/claude-sonnet-4-6.tools.json) | [prompt](../capture/cli/2.1.216/claude-sonnet-4-6.md) | [tools](../capture/cli/2.1.216/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../capture/sdk/2.1.216/claude-sonnet-5.md) | [tools](../capture/sdk/2.1.216/claude-sonnet-5.tools.json) | [prompt](../capture/cli/2.1.216/claude-sonnet-5.md) | [tools](../capture/cli/2.1.216/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
