...
prev [2.1.68](2.1.68.md) (same day earlier) · next [2.1.70](2.1.70.md) (2 days later)
...
- tools touched: Agent, AskUserQuestion, Bash, Edit, EnterPlanMode, EnterWorktree, ExitPlanMode, Glob, Grep, NotebookEdit, Read, Skill, TaskCreate, TaskGet, TaskList, TaskOutput, TaskStop, TaskUpdate, TodoWrite, ToolSearch, WebFetch, WebSearch, Write
- changelog coverage: 103 entries; prompt changes mentioned ("system prompt" appears); tools mentioned by name: Agent, Bash, WebFetch, AskUserQuestion

## SDK changes

Measured against 2.1.68, sdk-cli entrypoint:

- **9 models** (all except `claude-haiku-4-5`): prompt +264B 🟠 ~[auto memory] · tools 🟢 +[ToolSearch] 🔴 −[Agent, TaskOutput, Bash, Glob, Grep, ExitPlanMode, Read, Edit, Write, NotebookEdit, WebFetch, TodoWrite, WebSearch, TaskStop, AskUserQuestion, Skill, EnterPlanMode, EnterWorktree]
- `claude-haiku-4-5`: prompt +264B 🟠 ~[auto memory] · tools 🟠 schema[Agent, AskUserQuestion] 🟠 desc[Agent]

## Interactive CLI changes

Measured against 2.1.68:

- **9 models** (all except `claude-haiku-4-5`): prompt +264B 🟠 ~[auto memory] · tools 🟢 +[ToolSearch] 🔴 −[Agent, TaskOutput, Bash, Glob, Grep, ExitPlanMode, Read, Edit, Write, NotebookEdit, WebFetch, WebSearch, TaskStop, AskUserQuestion, Skill, EnterPlanMode, TaskCreate, TaskGet, TaskUpdate, TaskList, EnterWorktree]
- `claude-haiku-4-5`: prompt +264B 🟠 ~[auto memory] · tools 🟠 schema[Agent, AskUserQuestion] 🟠 desc[Agent, AskUserQuestion, TaskCreate]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../sdk-capture/2.1.69/claude-fable-5.md) | [tools](../sdk-capture/2.1.69/claude-fable-5.tools.json) | [prompt](../cli-capture/2.1.69/claude-fable-5.md) | [tools](../cli-capture/2.1.69/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../sdk-capture/2.1.69/claude-haiku-4-5.md) | [tools](../sdk-capture/2.1.69/claude-haiku-4-5.tools.json) | [prompt](../cli-capture/2.1.69/claude-haiku-4-5.md) | [tools](../cli-capture/2.1.69/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../sdk-capture/2.1.69/claude-opus-4-5.md) | [tools](../sdk-capture/2.1.69/claude-opus-4-5.tools.json) | [prompt](../cli-capture/2.1.69/claude-opus-4-5.md) | [tools](../cli-capture/2.1.69/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../sdk-capture/2.1.69/claude-opus-4-6.md) | [tools](../sdk-capture/2.1.69/claude-opus-4-6.tools.json) | [prompt](../cli-capture/2.1.69/claude-opus-4-6.md) | [tools](../cli-capture/2.1.69/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../sdk-capture/2.1.69/claude-opus-4-7.md) | [tools](../sdk-capture/2.1.69/claude-opus-4-7.tools.json) | [prompt](../cli-capture/2.1.69/claude-opus-4-7.md) | [tools](../cli-capture/2.1.69/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../sdk-capture/2.1.69/claude-opus-4-8.md) | [tools](../sdk-capture/2.1.69/claude-opus-4-8.tools.json) | [prompt](../cli-capture/2.1.69/claude-opus-4-8.md) | [tools](../cli-capture/2.1.69/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../sdk-capture/2.1.69/claude-opus-5.md) | [tools](../sdk-capture/2.1.69/claude-opus-5.tools.json) | [prompt](../cli-capture/2.1.69/claude-opus-5.md) | [tools](../cli-capture/2.1.69/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../sdk-capture/2.1.69/claude-sonnet-4-5.md) | [tools](../sdk-capture/2.1.69/claude-sonnet-4-5.tools.json) | [prompt](../cli-capture/2.1.69/claude-sonnet-4-5.md) | [tools](../cli-capture/2.1.69/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../sdk-capture/2.1.69/claude-sonnet-4-6.md) | [tools](../sdk-capture/2.1.69/claude-sonnet-4-6.tools.json) | [prompt](../cli-capture/2.1.69/claude-sonnet-4-6.md) | [tools](../cli-capture/2.1.69/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../sdk-capture/2.1.69/claude-sonnet-5.md) | [tools](../sdk-capture/2.1.69/claude-sonnet-5.tools.json) | [prompt](../cli-capture/2.1.69/claude-sonnet-5.md) | [tools](../cli-capture/2.1.69/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
