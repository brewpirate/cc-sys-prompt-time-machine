...
prev [2.1.81](2.1.81.md) (4 days earlier) · next [2.1.84](2.1.84.md) (1 day later)
...
- tools touched: Bash, CronCreate, CronDelete, CronList, EnterWorktree, TaskOutput
- changelog coverage: 76 entries; prompt changes **not mentioned**; tools mentioned by name: Bash, TaskOutput

## SDK changes

Measured against 2.1.81, sdk-cli entrypoint:

- **7 models** (all except `claude-fable-5`, `claude-opus-5`, `claude-sonnet-5`): prompt +10588B 🟠 ~[auto memory, Environment] · tools 🟠 schema[Bash, CronCreate, EnterWorktree] 🟠 desc[CronCreate, CronDelete, CronList, TaskOutput]
- `claude-fable-5`, `claude-opus-5`, `claude-sonnet-5`: prompt +10590B 🟠 ~[auto memory, Environment] · tools 🟠 schema[Bash, CronCreate, EnterWorktree] 🟠 desc[CronCreate, CronDelete, CronList, TaskOutput]

## Interactive CLI changes

Measured against 2.1.81:
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../capture/sdk/2.1.83/claude-fable-5.md) | [tools](../capture/sdk/2.1.83/claude-fable-5.tools.json) | [prompt](../capture/cli/2.1.83/claude-fable-5.md) | [tools](../capture/cli/2.1.83/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../capture/sdk/2.1.83/claude-haiku-4-5.md) | [tools](../capture/sdk/2.1.83/claude-haiku-4-5.tools.json) | [prompt](../capture/cli/2.1.83/claude-haiku-4-5.md) | [tools](../capture/cli/2.1.83/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../capture/sdk/2.1.83/claude-opus-4-5.md) | [tools](../capture/sdk/2.1.83/claude-opus-4-5.tools.json) | [prompt](../capture/cli/2.1.83/claude-opus-4-5.md) | [tools](../capture/cli/2.1.83/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../capture/sdk/2.1.83/claude-opus-4-6.md) | [tools](../capture/sdk/2.1.83/claude-opus-4-6.tools.json) | [prompt](../capture/cli/2.1.83/claude-opus-4-6.md) | [tools](../capture/cli/2.1.83/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../capture/sdk/2.1.83/claude-opus-4-7.md) | [tools](../capture/sdk/2.1.83/claude-opus-4-7.tools.json) | [prompt](../capture/cli/2.1.83/claude-opus-4-7.md) | [tools](../capture/cli/2.1.83/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../capture/sdk/2.1.83/claude-opus-4-8.md) | [tools](../capture/sdk/2.1.83/claude-opus-4-8.tools.json) | [prompt](../capture/cli/2.1.83/claude-opus-4-8.md) | [tools](../capture/cli/2.1.83/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../capture/sdk/2.1.83/claude-opus-5.md) | [tools](../capture/sdk/2.1.83/claude-opus-5.tools.json) | [prompt](../capture/cli/2.1.83/claude-opus-5.md) | [tools](../capture/cli/2.1.83/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../capture/sdk/2.1.83/claude-sonnet-4-5.md) | [tools](../capture/sdk/2.1.83/claude-sonnet-4-5.tools.json) | [prompt](../capture/cli/2.1.83/claude-sonnet-4-5.md) | [tools](../capture/cli/2.1.83/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../capture/sdk/2.1.83/claude-sonnet-4-6.md) | [tools](../capture/sdk/2.1.83/claude-sonnet-4-6.tools.json) | [prompt](../capture/cli/2.1.83/claude-sonnet-4-6.md) | [tools](../capture/cli/2.1.83/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../capture/sdk/2.1.83/claude-sonnet-5.md) | [tools](../capture/sdk/2.1.83/claude-sonnet-5.tools.json) | [prompt](../capture/cli/2.1.83/claude-sonnet-5.md) | [tools](../capture/cli/2.1.83/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
