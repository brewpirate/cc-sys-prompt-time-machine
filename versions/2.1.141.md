...
prev [2.1.140](2.1.140.md) (1 day earlier) · next [2.1.142](2.1.142.md) (1 day later)
...
- tools touched: Grep, ListMcpResourcesTool, ReadMcpResourceTool, WaitForMcpServers
- changelog coverage: 61 entries; prompt changes n/a; tools mentioned by name: **0 of 4**

## SDK changes

Measured against 2.1.140, sdk-cli entrypoint:

- **all 10 models**: tools 🔴 −[ListMcpResourcesTool, ReadMcpResourceTool] 🟠 schema[Grep]

## Interactive CLI changes

Measured against 2.1.140:

- `claude-haiku-4-5`: tools 🟢 +[WaitForMcpServers]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../capture/sdk/2.1.141/claude-fable-5.md) | [tools](../capture/sdk/2.1.141/claude-fable-5.tools.json) | [prompt](../capture/cli/2.1.141/claude-fable-5.md) | [tools](../capture/cli/2.1.141/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../capture/sdk/2.1.141/claude-haiku-4-5.md) | [tools](../capture/sdk/2.1.141/claude-haiku-4-5.tools.json) | [prompt](../capture/cli/2.1.141/claude-haiku-4-5.md) | [tools](../capture/cli/2.1.141/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../capture/sdk/2.1.141/claude-opus-4-5.md) | [tools](../capture/sdk/2.1.141/claude-opus-4-5.tools.json) | [prompt](../capture/cli/2.1.141/claude-opus-4-5.md) | [tools](../capture/cli/2.1.141/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../capture/sdk/2.1.141/claude-opus-4-6.md) | [tools](../capture/sdk/2.1.141/claude-opus-4-6.tools.json) | [prompt](../capture/cli/2.1.141/claude-opus-4-6.md) | [tools](../capture/cli/2.1.141/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../capture/sdk/2.1.141/claude-opus-4-7.md) | [tools](../capture/sdk/2.1.141/claude-opus-4-7.tools.json) | [prompt](../capture/cli/2.1.141/claude-opus-4-7.md) | [tools](../capture/cli/2.1.141/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../capture/sdk/2.1.141/claude-opus-4-8.md) | [tools](../capture/sdk/2.1.141/claude-opus-4-8.tools.json) | [prompt](../capture/cli/2.1.141/claude-opus-4-8.md) | [tools](../capture/cli/2.1.141/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../capture/sdk/2.1.141/claude-opus-5.md) | [tools](../capture/sdk/2.1.141/claude-opus-5.tools.json) | [prompt](../capture/cli/2.1.141/claude-opus-5.md) | [tools](../capture/cli/2.1.141/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../capture/sdk/2.1.141/claude-sonnet-4-5.md) | [tools](../capture/sdk/2.1.141/claude-sonnet-4-5.tools.json) | [prompt](../capture/cli/2.1.141/claude-sonnet-4-5.md) | [tools](../capture/cli/2.1.141/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../capture/sdk/2.1.141/claude-sonnet-4-6.md) | [tools](../capture/sdk/2.1.141/claude-sonnet-4-6.tools.json) | [prompt](../capture/cli/2.1.141/claude-sonnet-4-6.md) | [tools](../capture/cli/2.1.141/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../capture/sdk/2.1.141/claude-sonnet-5.md) | [tools](../capture/sdk/2.1.141/claude-sonnet-5.tools.json) | [prompt](../capture/cli/2.1.141/claude-sonnet-5.md) | [tools](../capture/cli/2.1.141/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
