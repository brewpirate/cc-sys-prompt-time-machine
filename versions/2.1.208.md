...
Measured against 2.1.205 — intermediate versions uncaptured on this entrypoint:

- **7 models** (all except `claude-fable-5`, `claude-opus-4-8`, `claude-opus-5`): prompt +363B 🟠 ~[Text output (does not apply to tool calls)] · tools 🟠 desc[ScheduleWakeup]
- `claude-fable-5`: prompt +421B 🟠 ~[Harness, Communicating with the user] · tools 🟠 desc[ScheduleWakeup]
- `claude-opus-4-8`: prompt +363B 🟠 ~[Harness] · tools 🟠 desc[ScheduleWakeup]
- `claude-opus-5`: prompt +421B 🟠 ~[Harness] · tools 🟠 desc[ScheduleWakeup]
