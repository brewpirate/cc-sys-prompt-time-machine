...
- changelog coverage: 50 entries; prompt changes n/a; tools mentioned by name: **0 of 1**
...
Measured against 2.1.143:

- **9 models** (all except `claude-opus-4-6`): tools 🔴 −[WaitForMcpServers]
