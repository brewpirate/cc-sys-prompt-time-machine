...
prev [2.1.104](2.1.104.md) (1 day earlier) · next [2.1.107](2.1.107.md) (1 day later)
...
- tools touched: Agent, EnterWorktree, ScheduleWakeup, TaskOutput
- changelog coverage: 37 entries; prompt changes **not mentioned**; tools mentioned by name: EnterWorktree

## SDK changes

Measured against 2.1.104, sdk-cli entrypoint:

- **all 10 models**: tools 🟠 schema[EnterWorktree] 🟠 desc[Agent, EnterWorktree]

## Interactive CLI changes

Measured against 2.1.100 — intermediate versions uncaptured on this entrypoint:

- **all 10 models**: prompt +391B 🟠 ~[Doing tasks] · tools 🟢 +[ScheduleWakeup] 🟠 schema[EnterWorktree] 🟠 desc[Agent, EnterWorktree, TaskOutput]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../sdk-capture/2.1.105/claude-fable-5.md) | [tools](../sdk-capture/2.1.105/claude-fable-5.tools.json) | [prompt](../cli-capture/2.1.105/claude-fable-5.md) | [tools](../cli-capture/2.1.105/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../sdk-capture/2.1.105/claude-haiku-4-5.md) | [tools](../sdk-capture/2.1.105/claude-haiku-4-5.tools.json) | [prompt](../cli-capture/2.1.105/claude-haiku-4-5.md) | [tools](../cli-capture/2.1.105/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../sdk-capture/2.1.105/claude-opus-4-5.md) | [tools](../sdk-capture/2.1.105/claude-opus-4-5.tools.json) | [prompt](../cli-capture/2.1.105/claude-opus-4-5.md) | [tools](../cli-capture/2.1.105/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../sdk-capture/2.1.105/claude-opus-4-6.md) | [tools](../sdk-capture/2.1.105/claude-opus-4-6.tools.json) | [prompt](../cli-capture/2.1.105/claude-opus-4-6.md) | [tools](../cli-capture/2.1.105/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../sdk-capture/2.1.105/claude-opus-4-7.md) | [tools](../sdk-capture/2.1.105/claude-opus-4-7.tools.json) | [prompt](../cli-capture/2.1.105/claude-opus-4-7.md) | [tools](../cli-capture/2.1.105/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../sdk-capture/2.1.105/claude-opus-4-8.md) | [tools](../sdk-capture/2.1.105/claude-opus-4-8.tools.json) | [prompt](../cli-capture/2.1.105/claude-opus-4-8.md) | [tools](../cli-capture/2.1.105/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../sdk-capture/2.1.105/claude-opus-5.md) | [tools](../sdk-capture/2.1.105/claude-opus-5.tools.json) | [prompt](../cli-capture/2.1.105/claude-opus-5.md) | [tools](../cli-capture/2.1.105/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../sdk-capture/2.1.105/claude-sonnet-4-5.md) | [tools](../sdk-capture/2.1.105/claude-sonnet-4-5.tools.json) | [prompt](../cli-capture/2.1.105/claude-sonnet-4-5.md) | [tools](../cli-capture/2.1.105/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../sdk-capture/2.1.105/claude-sonnet-4-6.md) | [tools](../sdk-capture/2.1.105/claude-sonnet-4-6.tools.json) | [prompt](../cli-capture/2.1.105/claude-sonnet-4-6.md) | [tools](../cli-capture/2.1.105/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../sdk-capture/2.1.105/claude-sonnet-5.md) | [tools](../sdk-capture/2.1.105/claude-sonnet-5.tools.json) | [prompt](../cli-capture/2.1.105/claude-sonnet-5.md) | [tools](../cli-capture/2.1.105/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
