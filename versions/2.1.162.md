...
prev [2.1.161](2.1.161.md) (1 day earlier) · next [2.1.163](2.1.163.md) (1 day later)
...
- prompts changed: 7/10 models (sdk), 0 (cli)
- tools touched: Agent, Bash, EnterPlanMode, Glob, Grep, NotebookEdit, WaitForMcpServers
- changelog coverage: 28 entries; prompt changes **not mentioned**; tools mentioned by name: Glob, Grep

## SDK changes

Measured against 2.1.161, sdk-cli entrypoint:

- **7 models** (all except `claude-fable-5`, `claude-opus-4-8`, `claude-opus-5`): prompt +6B 🟠 ~[Using your tools, Session-specific guidance] · tools 🔴 −[Glob, Grep] 🟠 desc[Agent, Bash, EnterPlanMode, NotebookEdit]
- `claude-fable-5`, `claude-opus-4-8`, `claude-opus-5`: tools 🔴 −[Glob, Grep] 🟠 desc[Bash, EnterPlanMode, NotebookEdit]

## Interactive CLI changes

Measured against 2.1.161:

- **9 models** (all except `claude-opus-4-5`): tools 🟢 +[WaitForMcpServers] 🟠 desc[NotebookEdit]
- `claude-opus-4-5`: tools 🟠 desc[NotebookEdit]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../sdk-capture/2.1.162/claude-fable-5.md) | [tools](../sdk-capture/2.1.162/claude-fable-5.tools.json) | [prompt](../cli-capture/2.1.162/claude-fable-5.md) | [tools](../cli-capture/2.1.162/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../sdk-capture/2.1.162/claude-haiku-4-5.md) | [tools](../sdk-capture/2.1.162/claude-haiku-4-5.tools.json) | [prompt](../cli-capture/2.1.162/claude-haiku-4-5.md) | [tools](../cli-capture/2.1.162/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../sdk-capture/2.1.162/claude-opus-4-5.md) | [tools](../sdk-capture/2.1.162/claude-opus-4-5.tools.json) | [prompt](../cli-capture/2.1.162/claude-opus-4-5.md) | [tools](../cli-capture/2.1.162/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../sdk-capture/2.1.162/claude-opus-4-6.md) | [tools](../sdk-capture/2.1.162/claude-opus-4-6.tools.json) | [prompt](../cli-capture/2.1.162/claude-opus-4-6.md) | [tools](../cli-capture/2.1.162/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../sdk-capture/2.1.162/claude-opus-4-7.md) | [tools](../sdk-capture/2.1.162/claude-opus-4-7.tools.json) | [prompt](../cli-capture/2.1.162/claude-opus-4-7.md) | [tools](../cli-capture/2.1.162/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../sdk-capture/2.1.162/claude-opus-4-8.md) | [tools](../sdk-capture/2.1.162/claude-opus-4-8.tools.json) | [prompt](../cli-capture/2.1.162/claude-opus-4-8.md) | [tools](../cli-capture/2.1.162/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../sdk-capture/2.1.162/claude-opus-5.md) | [tools](../sdk-capture/2.1.162/claude-opus-5.tools.json) | [prompt](../cli-capture/2.1.162/claude-opus-5.md) | [tools](../cli-capture/2.1.162/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../sdk-capture/2.1.162/claude-sonnet-4-5.md) | [tools](../sdk-capture/2.1.162/claude-sonnet-4-5.tools.json) | [prompt](../cli-capture/2.1.162/claude-sonnet-4-5.md) | [tools](../cli-capture/2.1.162/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../sdk-capture/2.1.162/claude-sonnet-4-6.md) | [tools](../sdk-capture/2.1.162/claude-sonnet-4-6.tools.json) | [prompt](../cli-capture/2.1.162/claude-sonnet-4-6.md) | [tools](../cli-capture/2.1.162/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../sdk-capture/2.1.162/claude-sonnet-5.md) | [tools](../sdk-capture/2.1.162/claude-sonnet-5.tools.json) | [prompt](../cli-capture/2.1.162/claude-sonnet-5.md) | [tools](../cli-capture/2.1.162/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
