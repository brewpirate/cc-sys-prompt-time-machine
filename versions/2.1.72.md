...
prev [2.1.71](2.1.71.md) (3 days earlier) · next [2.1.73](2.1.73.md) (2 days later)
...
- changelog coverage: 51 entries; prompt changes **not mentioned**; tools mentioned by name: ExitWorktree, Agent, WebFetch, EnterWorktree

## SDK changes

Measured against 2.1.71, sdk-cli entrypoint:

- **all 10 models**: prompt +162B 🟠 ~[Using your tools, Environment] · tools 🟢 +[ExitWorktree, CronCreate, CronDelete, CronList] 🟠 schema[Agent] 🟠 desc[WebFetch, EnterWorktree]

## Interactive CLI changes

Measured against 2.1.71:
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../sdk-capture/2.1.72/claude-fable-5.md) | [tools](../sdk-capture/2.1.72/claude-fable-5.tools.json) | [prompt](../cli-capture/2.1.72/claude-fable-5.md) | [tools](../cli-capture/2.1.72/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../sdk-capture/2.1.72/claude-haiku-4-5.md) | [tools](../sdk-capture/2.1.72/claude-haiku-4-5.tools.json) | [prompt](../cli-capture/2.1.72/claude-haiku-4-5.md) | [tools](../cli-capture/2.1.72/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../sdk-capture/2.1.72/claude-opus-4-5.md) | [tools](../sdk-capture/2.1.72/claude-opus-4-5.tools.json) | [prompt](../cli-capture/2.1.72/claude-opus-4-5.md) | [tools](../cli-capture/2.1.72/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../sdk-capture/2.1.72/claude-opus-4-6.md) | [tools](../sdk-capture/2.1.72/claude-opus-4-6.tools.json) | [prompt](../cli-capture/2.1.72/claude-opus-4-6.md) | [tools](../cli-capture/2.1.72/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../sdk-capture/2.1.72/claude-opus-4-7.md) | [tools](../sdk-capture/2.1.72/claude-opus-4-7.tools.json) | [prompt](../cli-capture/2.1.72/claude-opus-4-7.md) | [tools](../cli-capture/2.1.72/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../sdk-capture/2.1.72/claude-opus-4-8.md) | [tools](../sdk-capture/2.1.72/claude-opus-4-8.tools.json) | [prompt](../cli-capture/2.1.72/claude-opus-4-8.md) | [tools](../cli-capture/2.1.72/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../sdk-capture/2.1.72/claude-opus-5.md) | [tools](../sdk-capture/2.1.72/claude-opus-5.tools.json) | [prompt](../cli-capture/2.1.72/claude-opus-5.md) | [tools](../cli-capture/2.1.72/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../sdk-capture/2.1.72/claude-sonnet-4-5.md) | [tools](../sdk-capture/2.1.72/claude-sonnet-4-5.tools.json) | [prompt](../cli-capture/2.1.72/claude-sonnet-4-5.md) | [tools](../cli-capture/2.1.72/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../sdk-capture/2.1.72/claude-sonnet-4-6.md) | [tools](../sdk-capture/2.1.72/claude-sonnet-4-6.tools.json) | [prompt](../cli-capture/2.1.72/claude-sonnet-4-6.md) | [tools](../cli-capture/2.1.72/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../sdk-capture/2.1.72/claude-sonnet-5.md) | [tools](../sdk-capture/2.1.72/claude-sonnet-5.tools.json) | [prompt](../cli-capture/2.1.72/claude-sonnet-5.md) | [tools](../cli-capture/2.1.72/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
