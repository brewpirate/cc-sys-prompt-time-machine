...
prev [2.1.170](2.1.170.md) (1 day earlier) · next [2.1.173](2.1.173.md) (1 day later)
...
- prompts changed: 1/10 models (sdk), 10 (cli)
- tools touched: Agent, Bash, WaitForMcpServers
- changelog coverage: 30 entries; prompt changes **not mentioned**; tools mentioned by name: **0 of 3**

## SDK changes

Measured against 2.1.170, sdk-cli entrypoint:

- `claude-opus-5`, `claude-sonnet-5`: tools 🟠 desc[Bash]
- `claude-fable-5`: prompt +696B 🟠 ~[Communicating with the user]

## Interactive CLI changes

Measured against 2.1.168 — intermediate versions uncaptured on this entrypoint:

- **6 models** (all except `claude-fable-5`, `claude-opus-4-5`, `claude-opus-5`, `claude-sonnet-5`): prompt +324B 🟠 ~[Environment, Context management] · tools 🟠 schema[Agent]
- `claude-opus-5`, `claude-sonnet-5`: prompt +324B 🟠 ~[Environment, Context management] · tools 🟠 schema[Agent] 🟠 desc[Bash]
- `claude-fable-5`: prompt +4822B 🟢 +[Communicating with the user] 🟠 ~[Harness, Environment, Context management] · tools 🟠 schema[Agent] 🟠 desc[Bash]
- `claude-opus-4-5`: prompt +324B 🟠 ~[Environment, Context management] · tools 🟢 +[WaitForMcpServers] 🟠 schema[Agent]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../sdk-capture/2.1.172/claude-fable-5.md) | [tools](../sdk-capture/2.1.172/claude-fable-5.tools.json) | [prompt](../cli-capture/2.1.172/claude-fable-5.md) | [tools](../cli-capture/2.1.172/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../sdk-capture/2.1.172/claude-haiku-4-5.md) | [tools](../sdk-capture/2.1.172/claude-haiku-4-5.tools.json) | [prompt](../cli-capture/2.1.172/claude-haiku-4-5.md) | [tools](../cli-capture/2.1.172/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../sdk-capture/2.1.172/claude-opus-4-5.md) | [tools](../sdk-capture/2.1.172/claude-opus-4-5.tools.json) | [prompt](../cli-capture/2.1.172/claude-opus-4-5.md) | [tools](../cli-capture/2.1.172/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../sdk-capture/2.1.172/claude-opus-4-6.md) | [tools](../sdk-capture/2.1.172/claude-opus-4-6.tools.json) | [prompt](../cli-capture/2.1.172/claude-opus-4-6.md) | [tools](../cli-capture/2.1.172/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../sdk-capture/2.1.172/claude-opus-4-7.md) | [tools](../sdk-capture/2.1.172/claude-opus-4-7.tools.json) | [prompt](../cli-capture/2.1.172/claude-opus-4-7.md) | [tools](../cli-capture/2.1.172/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../sdk-capture/2.1.172/claude-opus-4-8.md) | [tools](../sdk-capture/2.1.172/claude-opus-4-8.tools.json) | [prompt](../cli-capture/2.1.172/claude-opus-4-8.md) | [tools](../cli-capture/2.1.172/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../sdk-capture/2.1.172/claude-opus-5.md) | [tools](../sdk-capture/2.1.172/claude-opus-5.tools.json) | [prompt](../cli-capture/2.1.172/claude-opus-5.md) | [tools](../cli-capture/2.1.172/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../sdk-capture/2.1.172/claude-sonnet-4-5.md) | [tools](../sdk-capture/2.1.172/claude-sonnet-4-5.tools.json) | [prompt](../cli-capture/2.1.172/claude-sonnet-4-5.md) | [tools](../cli-capture/2.1.172/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../sdk-capture/2.1.172/claude-sonnet-4-6.md) | [tools](../sdk-capture/2.1.172/claude-sonnet-4-6.tools.json) | [prompt](../cli-capture/2.1.172/claude-sonnet-4-6.md) | [tools](../cli-capture/2.1.172/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../sdk-capture/2.1.172/claude-sonnet-5.md) | [tools](../sdk-capture/2.1.172/claude-sonnet-5.tools.json) | [prompt](../cli-capture/2.1.172/claude-sonnet-5.md) | [tools](../cli-capture/2.1.172/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
