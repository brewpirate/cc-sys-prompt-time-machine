...
- changelog coverage: 30 entries; prompt changes **not mentioned**; tools mentioned by name: **0 of 2**
...
Measured against 2.1.170:

- `claude-haiku-4-5`, `claude-opus-4-6`, `claude-opus-4-8`, `claude-sonnet-4-5`, `claude-sonnet-4-6`: tools 🔴 −[WaitForMcpServers]
- `claude-opus-5`, `claude-sonnet-5`: tools 🔴 −[WaitForMcpServers] 🟠 desc[Bash]
- `claude-fable-5`: prompt +696B 🟠 ~[Communicating with the user] · tools 🔴 −[WaitForMcpServers]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../capture/sdk/2.1.172/claude-fable-5.md) | [tools](../capture/sdk/2.1.172/claude-fable-5.tools.json) | [prompt](../capture/cli/2.1.172/claude-fable-5.md) | [tools](../capture/cli/2.1.172/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../capture/sdk/2.1.172/claude-haiku-4-5.md) | [tools](../capture/sdk/2.1.172/claude-haiku-4-5.tools.json) | [prompt](../capture/cli/2.1.172/claude-haiku-4-5.md) | [tools](../capture/cli/2.1.172/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../capture/sdk/2.1.172/claude-opus-4-5.md) | [tools](../capture/sdk/2.1.172/claude-opus-4-5.tools.json) | [prompt](../capture/cli/2.1.172/claude-opus-4-5.md) | [tools](../capture/cli/2.1.172/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../capture/sdk/2.1.172/claude-opus-4-6.md) | [tools](../capture/sdk/2.1.172/claude-opus-4-6.tools.json) | [prompt](../capture/cli/2.1.172/claude-opus-4-6.md) | [tools](../capture/cli/2.1.172/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../capture/sdk/2.1.172/claude-opus-4-7.md) | [tools](../capture/sdk/2.1.172/claude-opus-4-7.tools.json) | [prompt](../capture/cli/2.1.172/claude-opus-4-7.md) | [tools](../capture/cli/2.1.172/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../capture/sdk/2.1.172/claude-opus-4-8.md) | [tools](../capture/sdk/2.1.172/claude-opus-4-8.tools.json) | [prompt](../capture/cli/2.1.172/claude-opus-4-8.md) | [tools](../capture/cli/2.1.172/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../capture/sdk/2.1.172/claude-opus-5.md) | [tools](../capture/sdk/2.1.172/claude-opus-5.tools.json) | [prompt](../capture/cli/2.1.172/claude-opus-5.md) | [tools](../capture/cli/2.1.172/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../capture/sdk/2.1.172/claude-sonnet-4-5.md) | [tools](../capture/sdk/2.1.172/claude-sonnet-4-5.tools.json) | [prompt](../capture/cli/2.1.172/claude-sonnet-4-5.md) | [tools](../capture/cli/2.1.172/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../capture/sdk/2.1.172/claude-sonnet-4-6.md) | [tools](../capture/sdk/2.1.172/claude-sonnet-4-6.tools.json) | [prompt](../capture/cli/2.1.172/claude-sonnet-4-6.md) | [tools](../capture/cli/2.1.172/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../capture/sdk/2.1.172/claude-sonnet-5.md) | [tools](../capture/sdk/2.1.172/claude-sonnet-5.tools.json) | [prompt](../capture/cli/2.1.172/claude-sonnet-5.md) | [tools](../capture/cli/2.1.172/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
