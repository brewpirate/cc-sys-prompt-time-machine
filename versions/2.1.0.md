...
prev [2.0.77](2.0.77.md) (1 day earlier) · next [2.1.1](2.1.1.md) (same day later)
...
- tools touched: LSP, WebSearch
- changelog coverage: 109 entries; prompt changes n/a; tools mentioned by name: LSP

## SDK changes

Measured against 2.0.77, sdk-cli entrypoint:

- **all 10 models**: tools 🔴 −[LSP]

## Interactive CLI changes

Measured against 2.0.77:

- **6 models** (all except `claude-fable-5`, `claude-haiku-4-5`, `claude-sonnet-4-6`, `claude-sonnet-5`): tools 🔴 −[LSP]
- `claude-fable-5`, `claude-haiku-4-5`, `claude-sonnet-4-6`, `claude-sonnet-5`: tools 🔴 −[LSP] 🟠 desc[WebSearch]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../capture/sdk/2.1.0/claude-fable-5.md) | [tools](../capture/sdk/2.1.0/claude-fable-5.tools.json) | [prompt](../capture/cli/2.1.0/claude-fable-5.md) | [tools](../capture/cli/2.1.0/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../capture/sdk/2.1.0/claude-haiku-4-5.md) | [tools](../capture/sdk/2.1.0/claude-haiku-4-5.tools.json) | [prompt](../capture/cli/2.1.0/claude-haiku-4-5.md) | [tools](../capture/cli/2.1.0/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../capture/sdk/2.1.0/claude-opus-4-5.md) | [tools](../capture/sdk/2.1.0/claude-opus-4-5.tools.json) | [prompt](../capture/cli/2.1.0/claude-opus-4-5.md) | [tools](../capture/cli/2.1.0/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../capture/sdk/2.1.0/claude-opus-4-6.md) | [tools](../capture/sdk/2.1.0/claude-opus-4-6.tools.json) | [prompt](../capture/cli/2.1.0/claude-opus-4-6.md) | [tools](../capture/cli/2.1.0/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../capture/sdk/2.1.0/claude-opus-4-7.md) | [tools](../capture/sdk/2.1.0/claude-opus-4-7.tools.json) | [prompt](../capture/cli/2.1.0/claude-opus-4-7.md) | [tools](../capture/cli/2.1.0/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../capture/sdk/2.1.0/claude-opus-4-8.md) | [tools](../capture/sdk/2.1.0/claude-opus-4-8.tools.json) | [prompt](../capture/cli/2.1.0/claude-opus-4-8.md) | [tools](../capture/cli/2.1.0/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../capture/sdk/2.1.0/claude-opus-5.md) | [tools](../capture/sdk/2.1.0/claude-opus-5.tools.json) | [prompt](../capture/cli/2.1.0/claude-opus-5.md) | [tools](../capture/cli/2.1.0/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../capture/sdk/2.1.0/claude-sonnet-4-5.md) | [tools](../capture/sdk/2.1.0/claude-sonnet-4-5.tools.json) | [prompt](../capture/cli/2.1.0/claude-sonnet-4-5.md) | [tools](../capture/cli/2.1.0/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../capture/sdk/2.1.0/claude-sonnet-4-6.md) | [tools](../capture/sdk/2.1.0/claude-sonnet-4-6.tools.json) | [prompt](../capture/cli/2.1.0/claude-sonnet-4-6.md) | [tools](../capture/cli/2.1.0/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../capture/sdk/2.1.0/claude-sonnet-5.md) | [tools](../capture/sdk/2.1.0/claude-sonnet-5.tools.json) | [prompt](../capture/cli/2.1.0/claude-sonnet-5.md) | [tools](../capture/cli/2.1.0/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
