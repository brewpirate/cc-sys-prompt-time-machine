...
prev [2.1.220](2.1.220.md) (10 days earlier) · next [2.1.222](2.1.222.md) (1 day later)
...
- changelog coverage: 39 entries; prompt changes **not mentioned**; tools mentioned by name: **0 of 1**

## SDK changes

Measured against 2.1.220, sdk-cli entrypoint:

- **all 10 models**: prompt -4B 🟠 ~[Environment]

## Interactive CLI changes

Measured against 2.1.220:

- **6 models** (all except `claude-haiku-4-5`, `claude-opus-4-5`, `claude-sonnet-4-5`, `claude-sonnet-5`): prompt -4B 🟠 ~[Environment]
- `claude-haiku-4-5`, `claude-opus-4-5`, `claude-sonnet-4-5`, `claude-sonnet-5`: prompt -4B 🟠 ~[Environment] · tools 🟢 +[WaitForMcpServers]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../capture/sdk/2.1.221/claude-fable-5.md) | [tools](../capture/sdk/2.1.221/claude-fable-5.tools.json) | [prompt](../capture/cli/2.1.221/claude-fable-5.md) | [tools](../capture/cli/2.1.221/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../capture/sdk/2.1.221/claude-haiku-4-5.md) | [tools](../capture/sdk/2.1.221/claude-haiku-4-5.tools.json) | [prompt](../capture/cli/2.1.221/claude-haiku-4-5.md) | [tools](../capture/cli/2.1.221/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../capture/sdk/2.1.221/claude-opus-4-5.md) | [tools](../capture/sdk/2.1.221/claude-opus-4-5.tools.json) | [prompt](../capture/cli/2.1.221/claude-opus-4-5.md) | [tools](../capture/cli/2.1.221/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../capture/sdk/2.1.221/claude-opus-4-6.md) | [tools](../capture/sdk/2.1.221/claude-opus-4-6.tools.json) | [prompt](../capture/cli/2.1.221/claude-opus-4-6.md) | [tools](../capture/cli/2.1.221/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../capture/sdk/2.1.221/claude-opus-4-7.md) | [tools](../capture/sdk/2.1.221/claude-opus-4-7.tools.json) | [prompt](../capture/cli/2.1.221/claude-opus-4-7.md) | [tools](../capture/cli/2.1.221/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../capture/sdk/2.1.221/claude-opus-4-8.md) | [tools](../capture/sdk/2.1.221/claude-opus-4-8.tools.json) | [prompt](../capture/cli/2.1.221/claude-opus-4-8.md) | [tools](../capture/cli/2.1.221/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../capture/sdk/2.1.221/claude-opus-5.md) | [tools](../capture/sdk/2.1.221/claude-opus-5.tools.json) | [prompt](../capture/cli/2.1.221/claude-opus-5.md) | [tools](../capture/cli/2.1.221/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../capture/sdk/2.1.221/claude-sonnet-4-5.md) | [tools](../capture/sdk/2.1.221/claude-sonnet-4-5.tools.json) | [prompt](../capture/cli/2.1.221/claude-sonnet-4-5.md) | [tools](../capture/cli/2.1.221/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../capture/sdk/2.1.221/claude-sonnet-4-6.md) | [tools](../capture/sdk/2.1.221/claude-sonnet-4-6.tools.json) | [prompt](../capture/cli/2.1.221/claude-sonnet-4-6.md) | [tools](../capture/cli/2.1.221/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../capture/sdk/2.1.221/claude-sonnet-5.md) | [tools](../capture/sdk/2.1.221/claude-sonnet-5.tools.json) | [prompt](../capture/cli/2.1.221/claude-sonnet-5.md) | [tools](../capture/cli/2.1.221/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
