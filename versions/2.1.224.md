...
prev [2.1.223](2.1.223.md) (2 days earlier) · next [2.1.225](2.1.225.md) (same day later)
...
- tools touched: Bash
- changelog coverage: 31 entries; prompt changes n/a; tools mentioned by name: Bash

## SDK changes

Measured against 2.1.223, sdk-cli entrypoint:

- `claude-fable-5`, `claude-opus-4-8`: tools 🟠 desc[Bash]

## Interactive CLI changes

Measured against 2.1.223:
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../sdk-capture/2.1.224/claude-fable-5.md) | [tools](../sdk-capture/2.1.224/claude-fable-5.tools.json) | [prompt](../cli-capture/2.1.224/claude-fable-5.md) | [tools](../cli-capture/2.1.224/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../sdk-capture/2.1.224/claude-haiku-4-5.md) | [tools](../sdk-capture/2.1.224/claude-haiku-4-5.tools.json) | [prompt](../cli-capture/2.1.224/claude-haiku-4-5.md) | [tools](../cli-capture/2.1.224/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../sdk-capture/2.1.224/claude-opus-4-5.md) | [tools](../sdk-capture/2.1.224/claude-opus-4-5.tools.json) | [prompt](../cli-capture/2.1.224/claude-opus-4-5.md) | [tools](../cli-capture/2.1.224/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../sdk-capture/2.1.224/claude-opus-4-6.md) | [tools](../sdk-capture/2.1.224/claude-opus-4-6.tools.json) | [prompt](../cli-capture/2.1.224/claude-opus-4-6.md) | [tools](../cli-capture/2.1.224/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../sdk-capture/2.1.224/claude-opus-4-7.md) | [tools](../sdk-capture/2.1.224/claude-opus-4-7.tools.json) | [prompt](../cli-capture/2.1.224/claude-opus-4-7.md) | [tools](../cli-capture/2.1.224/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../sdk-capture/2.1.224/claude-opus-4-8.md) | [tools](../sdk-capture/2.1.224/claude-opus-4-8.tools.json) | [prompt](../cli-capture/2.1.224/claude-opus-4-8.md) | [tools](../cli-capture/2.1.224/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../sdk-capture/2.1.224/claude-opus-5.md) | [tools](../sdk-capture/2.1.224/claude-opus-5.tools.json) | [prompt](../cli-capture/2.1.224/claude-opus-5.md) | [tools](../cli-capture/2.1.224/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../sdk-capture/2.1.224/claude-sonnet-4-5.md) | [tools](../sdk-capture/2.1.224/claude-sonnet-4-5.tools.json) | [prompt](../cli-capture/2.1.224/claude-sonnet-4-5.md) | [tools](../cli-capture/2.1.224/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../sdk-capture/2.1.224/claude-sonnet-4-6.md) | [tools](../sdk-capture/2.1.224/claude-sonnet-4-6.tools.json) | [prompt](../cli-capture/2.1.224/claude-sonnet-4-6.md) | [tools](../cli-capture/2.1.224/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../sdk-capture/2.1.224/claude-sonnet-5.md) | [tools](../sdk-capture/2.1.224/claude-sonnet-5.tools.json) | [prompt](../cli-capture/2.1.224/claude-sonnet-5.md) | [tools](../cli-capture/2.1.224/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
