...
prev [2.1.168](2.1.168.md) (2 days earlier) · next [2.1.170](2.1.170.md) (1 day later)
...
- changelog coverage: 30 entries; prompt changes **not mentioned**; tools mentioned by name: **0 of 1**

## SDK changes

Measured against 2.1.168, sdk-cli entrypoint:

- **all 10 models**: prompt +279B 🟠 ~[Context management]

## Interactive CLI changes

Measured against 2.1.168:

- **all 10 models**: prompt +279B 🟠 ~[Context management] · tools 🟢 +[WaitForMcpServers]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../sdk-capture/2.1.169/claude-fable-5.md) | [tools](../sdk-capture/2.1.169/claude-fable-5.tools.json) | [prompt](../cli-capture/2.1.169/claude-fable-5.md) | [tools](../cli-capture/2.1.169/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../sdk-capture/2.1.169/claude-haiku-4-5.md) | [tools](../sdk-capture/2.1.169/claude-haiku-4-5.tools.json) | [prompt](../cli-capture/2.1.169/claude-haiku-4-5.md) | [tools](../cli-capture/2.1.169/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../sdk-capture/2.1.169/claude-opus-4-5.md) | [tools](../sdk-capture/2.1.169/claude-opus-4-5.tools.json) | [prompt](../cli-capture/2.1.169/claude-opus-4-5.md) | [tools](../cli-capture/2.1.169/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../sdk-capture/2.1.169/claude-opus-4-6.md) | [tools](../sdk-capture/2.1.169/claude-opus-4-6.tools.json) | [prompt](../cli-capture/2.1.169/claude-opus-4-6.md) | [tools](../cli-capture/2.1.169/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../sdk-capture/2.1.169/claude-opus-4-7.md) | [tools](../sdk-capture/2.1.169/claude-opus-4-7.tools.json) | [prompt](../cli-capture/2.1.169/claude-opus-4-7.md) | [tools](../cli-capture/2.1.169/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../sdk-capture/2.1.169/claude-opus-4-8.md) | [tools](../sdk-capture/2.1.169/claude-opus-4-8.tools.json) | [prompt](../cli-capture/2.1.169/claude-opus-4-8.md) | [tools](../cli-capture/2.1.169/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../sdk-capture/2.1.169/claude-opus-5.md) | [tools](../sdk-capture/2.1.169/claude-opus-5.tools.json) | [prompt](../cli-capture/2.1.169/claude-opus-5.md) | [tools](../cli-capture/2.1.169/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../sdk-capture/2.1.169/claude-sonnet-4-5.md) | [tools](../sdk-capture/2.1.169/claude-sonnet-4-5.tools.json) | [prompt](../cli-capture/2.1.169/claude-sonnet-4-5.md) | [tools](../cli-capture/2.1.169/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../sdk-capture/2.1.169/claude-sonnet-4-6.md) | [tools](../sdk-capture/2.1.169/claude-sonnet-4-6.tools.json) | [prompt](../cli-capture/2.1.169/claude-sonnet-4-6.md) | [tools](../cli-capture/2.1.169/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../sdk-capture/2.1.169/claude-sonnet-5.md) | [tools](../sdk-capture/2.1.169/claude-sonnet-5.tools.json) | [prompt](../cli-capture/2.1.169/claude-sonnet-5.md) | [tools](../cli-capture/2.1.169/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
