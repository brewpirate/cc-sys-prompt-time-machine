...
- tools touched: Bash, Edit, Task
- changelog coverage: 28 entries; prompt changes **not mentioned**; tools mentioned by name: Bash
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../sdk-capture/2.1.20/claude-fable-5.md) | [tools](../sdk-capture/2.1.20/claude-fable-5.tools.json) | — | — | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../sdk-capture/2.1.20/claude-haiku-4-5.md) | [tools](../sdk-capture/2.1.20/claude-haiku-4-5.tools.json) | — | — | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../sdk-capture/2.1.20/claude-opus-4-5.md) | [tools](../sdk-capture/2.1.20/claude-opus-4-5.tools.json) | — | — | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../sdk-capture/2.1.20/claude-opus-4-6.md) | [tools](../sdk-capture/2.1.20/claude-opus-4-6.tools.json) | — | — | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../sdk-capture/2.1.20/claude-opus-4-7.md) | [tools](../sdk-capture/2.1.20/claude-opus-4-7.tools.json) | — | — | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../sdk-capture/2.1.20/claude-opus-4-8.md) | [tools](../sdk-capture/2.1.20/claude-opus-4-8.tools.json) | — | — | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../sdk-capture/2.1.20/claude-opus-5.md) | [tools](../sdk-capture/2.1.20/claude-opus-5.tools.json) | — | — | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../sdk-capture/2.1.20/claude-sonnet-4-5.md) | [tools](../sdk-capture/2.1.20/claude-sonnet-4-5.tools.json) | — | — | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../sdk-capture/2.1.20/claude-sonnet-4-6.md) | [tools](../sdk-capture/2.1.20/claude-sonnet-4-6.tools.json) | — | — | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../sdk-capture/2.1.20/claude-sonnet-5.md) | [tools](../sdk-capture/2.1.20/claude-sonnet-5.tools.json) | — | — | [dossier](../models/claude-sonnet-5.md) |
