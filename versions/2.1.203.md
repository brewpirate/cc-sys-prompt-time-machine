...
prev [2.1.202](2.1.202.md) (1 day earlier) · next [2.1.204](2.1.204.md) (1 day later)
...
- tools touched: EnterWorktree, SendMessage, WaitForMcpServers
- changelog coverage: 37 entries; prompt changes n/a; tools mentioned by name: **0 of 3**

## SDK changes

Measured against 2.1.202, sdk-cli entrypoint:

- **all 10 models**: tools 🟠 schema[EnterWorktree] 🟠 desc[EnterWorktree, SendMessage]

## Interactive CLI changes

Measured against 2.1.202:

- **7 models** (all except `claude-fable-5`, `claude-haiku-4-5`, `claude-opus-5`): tools 🟢 +[WaitForMcpServers] 🟠 schema[EnterWorktree] 🟠 desc[EnterWorktree, SendMessage]
- `claude-fable-5`, `claude-haiku-4-5`, `claude-opus-5`: tools 🟠 schema[EnterWorktree] 🟠 desc[EnterWorktree, SendMessage]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../sdk-capture/2.1.203/claude-fable-5.md) | [tools](../sdk-capture/2.1.203/claude-fable-5.tools.json) | [prompt](../cli-capture/2.1.203/claude-fable-5.md) | [tools](../cli-capture/2.1.203/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../sdk-capture/2.1.203/claude-haiku-4-5.md) | [tools](../sdk-capture/2.1.203/claude-haiku-4-5.tools.json) | [prompt](../cli-capture/2.1.203/claude-haiku-4-5.md) | [tools](../cli-capture/2.1.203/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../sdk-capture/2.1.203/claude-opus-4-5.md) | [tools](../sdk-capture/2.1.203/claude-opus-4-5.tools.json) | [prompt](../cli-capture/2.1.203/claude-opus-4-5.md) | [tools](../cli-capture/2.1.203/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../sdk-capture/2.1.203/claude-opus-4-6.md) | [tools](../sdk-capture/2.1.203/claude-opus-4-6.tools.json) | [prompt](../cli-capture/2.1.203/claude-opus-4-6.md) | [tools](../cli-capture/2.1.203/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../sdk-capture/2.1.203/claude-opus-4-7.md) | [tools](../sdk-capture/2.1.203/claude-opus-4-7.tools.json) | [prompt](../cli-capture/2.1.203/claude-opus-4-7.md) | [tools](../cli-capture/2.1.203/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../sdk-capture/2.1.203/claude-opus-4-8.md) | [tools](../sdk-capture/2.1.203/claude-opus-4-8.tools.json) | [prompt](../cli-capture/2.1.203/claude-opus-4-8.md) | [tools](../cli-capture/2.1.203/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../sdk-capture/2.1.203/claude-opus-5.md) | [tools](../sdk-capture/2.1.203/claude-opus-5.tools.json) | [prompt](../cli-capture/2.1.203/claude-opus-5.md) | [tools](../cli-capture/2.1.203/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../sdk-capture/2.1.203/claude-sonnet-4-5.md) | [tools](../sdk-capture/2.1.203/claude-sonnet-4-5.tools.json) | [prompt](../cli-capture/2.1.203/claude-sonnet-4-5.md) | [tools](../cli-capture/2.1.203/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../sdk-capture/2.1.203/claude-sonnet-4-6.md) | [tools](../sdk-capture/2.1.203/claude-sonnet-4-6.tools.json) | [prompt](../cli-capture/2.1.203/claude-sonnet-4-6.md) | [tools](../cli-capture/2.1.203/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../sdk-capture/2.1.203/claude-sonnet-5.md) | [tools](../sdk-capture/2.1.203/claude-sonnet-5.tools.json) | [prompt](../cli-capture/2.1.203/claude-sonnet-5.md) | [tools](../cli-capture/2.1.203/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
