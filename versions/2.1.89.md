...
prev [2.1.87](2.1.87.md) (2 days earlier) · next [2.1.90](2.1.90.md) (1 day later)
...
- tools touched: Agent, Read
- changelog coverage: 52 entries; prompt changes **not mentioned**; tools mentioned by name: Read

## SDK changes

Measured against 2.1.87, sdk-cli entrypoint:

- **all 10 models**: prompt +32B 🟢 +[Session-specific guidance] 🟠 ~[System, Using your tools] · tools 🟠 schema[Read] 🟠 desc[Agent]

## Interactive CLI changes

Measured against 2.1.87:

- **all 10 models**: prompt +31B 🟢 +[Session-specific guidance] 🟠 ~[System, Using your tools, Output efficiency] · tools 🟠 schema[Read] 🟠 desc[Agent]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../capture/sdk/2.1.89/claude-fable-5.md) | [tools](../capture/sdk/2.1.89/claude-fable-5.tools.json) | [prompt](../capture/cli/2.1.89/claude-fable-5.md) | [tools](../capture/cli/2.1.89/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../capture/sdk/2.1.89/claude-haiku-4-5.md) | [tools](../capture/sdk/2.1.89/claude-haiku-4-5.tools.json) | [prompt](../capture/cli/2.1.89/claude-haiku-4-5.md) | [tools](../capture/cli/2.1.89/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../capture/sdk/2.1.89/claude-opus-4-5.md) | [tools](../capture/sdk/2.1.89/claude-opus-4-5.tools.json) | [prompt](../capture/cli/2.1.89/claude-opus-4-5.md) | [tools](../capture/cli/2.1.89/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../capture/sdk/2.1.89/claude-opus-4-6.md) | [tools](../capture/sdk/2.1.89/claude-opus-4-6.tools.json) | [prompt](../capture/cli/2.1.89/claude-opus-4-6.md) | [tools](../capture/cli/2.1.89/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../capture/sdk/2.1.89/claude-opus-4-7.md) | [tools](../capture/sdk/2.1.89/claude-opus-4-7.tools.json) | [prompt](../capture/cli/2.1.89/claude-opus-4-7.md) | [tools](../capture/cli/2.1.89/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../capture/sdk/2.1.89/claude-opus-4-8.md) | [tools](../capture/sdk/2.1.89/claude-opus-4-8.tools.json) | [prompt](../capture/cli/2.1.89/claude-opus-4-8.md) | [tools](../capture/cli/2.1.89/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../capture/sdk/2.1.89/claude-opus-5.md) | [tools](../capture/sdk/2.1.89/claude-opus-5.tools.json) | [prompt](../capture/cli/2.1.89/claude-opus-5.md) | [tools](../capture/cli/2.1.89/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../capture/sdk/2.1.89/claude-sonnet-4-5.md) | [tools](../capture/sdk/2.1.89/claude-sonnet-4-5.tools.json) | [prompt](../capture/cli/2.1.89/claude-sonnet-4-5.md) | [tools](../capture/cli/2.1.89/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../capture/sdk/2.1.89/claude-sonnet-4-6.md) | [tools](../capture/sdk/2.1.89/claude-sonnet-4-6.tools.json) | [prompt](../capture/cli/2.1.89/claude-sonnet-4-6.md) | [tools](../capture/cli/2.1.89/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../capture/sdk/2.1.89/claude-sonnet-5.md) | [tools](../capture/sdk/2.1.89/claude-sonnet-5.tools.json) | [prompt](../capture/cli/2.1.89/claude-sonnet-5.md) | [tools](../capture/cli/2.1.89/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
