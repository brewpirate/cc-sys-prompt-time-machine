...
prev [2.1.209](2.1.209.md) (same day earlier) · next [2.1.211](2.1.211.md) (1 day later)
...
Measured against 2.1.209, sdk-cli entrypoint:

- none measured

## Interactive CLI changes

Measured against 2.1.209:

- `claude-fable-5`, `claude-haiku-4-5`, `claude-opus-4-5`, `claude-sonnet-4-5`, `claude-sonnet-4-6`: tools 🟢 +[WaitForMcpServers]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../sdk-capture/2.1.210/claude-fable-5.md) | [tools](../sdk-capture/2.1.210/claude-fable-5.tools.json) | [prompt](../cli-capture/2.1.210/claude-fable-5.md) | [tools](../cli-capture/2.1.210/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../sdk-capture/2.1.210/claude-haiku-4-5.md) | [tools](../sdk-capture/2.1.210/claude-haiku-4-5.tools.json) | [prompt](../cli-capture/2.1.210/claude-haiku-4-5.md) | [tools](../cli-capture/2.1.210/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../sdk-capture/2.1.210/claude-opus-4-5.md) | [tools](../sdk-capture/2.1.210/claude-opus-4-5.tools.json) | [prompt](../cli-capture/2.1.210/claude-opus-4-5.md) | [tools](../cli-capture/2.1.210/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../sdk-capture/2.1.210/claude-opus-4-6.md) | [tools](../sdk-capture/2.1.210/claude-opus-4-6.tools.json) | [prompt](../cli-capture/2.1.210/claude-opus-4-6.md) | [tools](../cli-capture/2.1.210/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../sdk-capture/2.1.210/claude-opus-4-7.md) | [tools](../sdk-capture/2.1.210/claude-opus-4-7.tools.json) | [prompt](../cli-capture/2.1.210/claude-opus-4-7.md) | [tools](../cli-capture/2.1.210/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../sdk-capture/2.1.210/claude-opus-4-8.md) | [tools](../sdk-capture/2.1.210/claude-opus-4-8.tools.json) | [prompt](../cli-capture/2.1.210/claude-opus-4-8.md) | [tools](../cli-capture/2.1.210/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../sdk-capture/2.1.210/claude-opus-5.md) | [tools](../sdk-capture/2.1.210/claude-opus-5.tools.json) | [prompt](../cli-capture/2.1.210/claude-opus-5.md) | [tools](../cli-capture/2.1.210/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../sdk-capture/2.1.210/claude-sonnet-4-5.md) | [tools](../sdk-capture/2.1.210/claude-sonnet-4-5.tools.json) | [prompt](../cli-capture/2.1.210/claude-sonnet-4-5.md) | [tools](../cli-capture/2.1.210/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../sdk-capture/2.1.210/claude-sonnet-4-6.md) | [tools](../sdk-capture/2.1.210/claude-sonnet-4-6.tools.json) | [prompt](../cli-capture/2.1.210/claude-sonnet-4-6.md) | [tools](../cli-capture/2.1.210/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../sdk-capture/2.1.210/claude-sonnet-5.md) | [tools](../sdk-capture/2.1.210/claude-sonnet-5.tools.json) | [prompt](../cli-capture/2.1.210/claude-sonnet-5.md) | [tools](../cli-capture/2.1.210/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
