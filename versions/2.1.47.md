...
prev [2.1.45](2.1.45.md) (1 day earlier) · next [2.1.48](2.1.48.md) (1 day later)
...
- changelog coverage: 68 entries; prompt changes **not mentioned**; tools mentioned by name: AskUserQuestion, Bash

## SDK changes

Measured against 2.1.45, sdk-cli entrypoint:

- **all 10 models**: prompt +308B 🟠 ~[Tool usage policy] · tools 🟠 desc[AskUserQuestion]

## Interactive CLI changes

Measured against 2.1.42 — intermediate versions uncaptured on this entrypoint:

- **9 models** (all except `claude-sonnet-4-6`): prompt +308B 🟠 ~[Tool usage policy] · tools 🟠 schema[AskUserQuestion] 🟠 desc[AskUserQuestion]
- `claude-sonnet-4-6`: prompt +309B 🟠 ~[Tool usage policy, Code References] · tools 🟠 schema[AskUserQuestion] 🟠 desc[Bash, AskUserQuestion]
...
| --- | --- | --- | --- | --- | --- |
| claude-fable-5 | [prompt](../sdk-capture/2.1.47/claude-fable-5.md) | [tools](../sdk-capture/2.1.47/claude-fable-5.tools.json) | [prompt](../cli-capture/2.1.47/claude-fable-5.md) | [tools](../cli-capture/2.1.47/claude-fable-5.tools.json) | [dossier](../models/claude-fable-5.md) |
| claude-haiku-4-5 | [prompt](../sdk-capture/2.1.47/claude-haiku-4-5.md) | [tools](../sdk-capture/2.1.47/claude-haiku-4-5.tools.json) | [prompt](../cli-capture/2.1.47/claude-haiku-4-5.md) | [tools](../cli-capture/2.1.47/claude-haiku-4-5.tools.json) | [dossier](../models/claude-haiku-4-5.md) |
| claude-opus-4-5 | [prompt](../sdk-capture/2.1.47/claude-opus-4-5.md) | [tools](../sdk-capture/2.1.47/claude-opus-4-5.tools.json) | [prompt](../cli-capture/2.1.47/claude-opus-4-5.md) | [tools](../cli-capture/2.1.47/claude-opus-4-5.tools.json) | [dossier](../models/claude-opus-4-5.md) |
| claude-opus-4-6 | [prompt](../sdk-capture/2.1.47/claude-opus-4-6.md) | [tools](../sdk-capture/2.1.47/claude-opus-4-6.tools.json) | [prompt](../cli-capture/2.1.47/claude-opus-4-6.md) | [tools](../cli-capture/2.1.47/claude-opus-4-6.tools.json) | [dossier](../models/claude-opus-4-6.md) |
| claude-opus-4-7 | [prompt](../sdk-capture/2.1.47/claude-opus-4-7.md) | [tools](../sdk-capture/2.1.47/claude-opus-4-7.tools.json) | [prompt](../cli-capture/2.1.47/claude-opus-4-7.md) | [tools](../cli-capture/2.1.47/claude-opus-4-7.tools.json) | [dossier](../models/claude-opus-4-7.md) |
| claude-opus-4-8 | [prompt](../sdk-capture/2.1.47/claude-opus-4-8.md) | [tools](../sdk-capture/2.1.47/claude-opus-4-8.tools.json) | [prompt](../cli-capture/2.1.47/claude-opus-4-8.md) | [tools](../cli-capture/2.1.47/claude-opus-4-8.tools.json) | [dossier](../models/claude-opus-4-8.md) |
| claude-opus-5 | [prompt](../sdk-capture/2.1.47/claude-opus-5.md) | [tools](../sdk-capture/2.1.47/claude-opus-5.tools.json) | [prompt](../cli-capture/2.1.47/claude-opus-5.md) | [tools](../cli-capture/2.1.47/claude-opus-5.tools.json) | [dossier](../models/claude-opus-5.md) |
| claude-sonnet-4-5 | [prompt](../sdk-capture/2.1.47/claude-sonnet-4-5.md) | [tools](../sdk-capture/2.1.47/claude-sonnet-4-5.tools.json) | [prompt](../cli-capture/2.1.47/claude-sonnet-4-5.md) | [tools](../cli-capture/2.1.47/claude-sonnet-4-5.tools.json) | [dossier](../models/claude-sonnet-4-5.md) |
| claude-sonnet-4-6 | [prompt](../sdk-capture/2.1.47/claude-sonnet-4-6.md) | [tools](../sdk-capture/2.1.47/claude-sonnet-4-6.tools.json) | [prompt](../cli-capture/2.1.47/claude-sonnet-4-6.md) | [tools](../cli-capture/2.1.47/claude-sonnet-4-6.tools.json) | [dossier](../models/claude-sonnet-4-6.md) |
| claude-sonnet-5 | [prompt](../sdk-capture/2.1.47/claude-sonnet-5.md) | [tools](../sdk-capture/2.1.47/claude-sonnet-5.tools.json) | [prompt](../cli-capture/2.1.47/claude-sonnet-5.md) | [tools](../cli-capture/2.1.47/claude-sonnet-5.tools.json) | [dossier](../models/claude-sonnet-5.md) |
