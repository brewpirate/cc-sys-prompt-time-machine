...
384 versions captured in both trees (1.0.3 → 2.1.232), grouped into runs by family pair and section divergence:
...
| 1.0.128 – 2.0.26 | 2025-09-27 → 2025-10-23 | claude-code / sdk-legacy | — | — | -5 |
...
Interactive holes — honest exclusions, not gaps: 0.2.9 (no-prompt-captured), 0.2.14 (no-prompt-captured), 1.0.0 (model-remapped → claude-opus-4-20250514), 1.0.45 (no-prompt-captured), 2.0.19 (model-remapped → claude-haiku-4-5-20251001), 2.0.24 (model-remapped → claude-haiku-4-5-20251001), 2.0.27 (model-remapped → claude-haiku-4-5-20251001).
