...
386 versions captured in both trees (1.0.3 → 2.1.232), grouped into runs by family pair and section divergence:
...
Interactive holes — honest exclusions, not gaps: 0.2.9 (no-prompt-captured), 1.0.0 (model-remapped → claude-opus-4-20250514), 1.0.45 (no-prompt-captured), 2.0.21 (model-remapped → claude-haiku-4-5-20251001).
