...
Generated 2026-08-14 by `bun run watch` against sdk 2.1.232 / cli 2.1.232. Run after
...
| cli↔sdk doctrinal parity | identical section sets (opus-5, newest common build) | 🟢 | identical at 2.1.232 | the entrypoints fork doctrinally — the nerf-theory tripwire |
